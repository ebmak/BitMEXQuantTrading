...
class BitMEXWebsocket():
    ...
    def connect(self, endpoint="", symbol="", shouldAuth=True):
        ...
        subscriptions = [sub + ':' + symbol for sub in ["orderBookL2_25", "trade"]]
    ...
    def __on_message(self, message):
        ...
        # self.logger.info(pprint.pformat(message))
        ...
        # self.logger.info(self.data.get("orderBookL2_25"))
...
if __name__ == "__main__":
    ...
    ws.connect("https://www.bitmex.com/api/v1/", "XBTUSD", True)
